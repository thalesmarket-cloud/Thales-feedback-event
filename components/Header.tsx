...
const Header: React.FC = () => {
  ...
  return (
    <div className="text-center mb-10 w-full animate-in fade-in slide-in-from-top-4 duration-1000">
      ...
      <h1 className="text-4xl font-black text-white mb-4 tracking-tight drop-shadow-sm">Votre avis compte</h1>
      <p className="text-blue-100 max-w-2xl mx-auto leading-relaxed text-lg font-medium opacity-90">
