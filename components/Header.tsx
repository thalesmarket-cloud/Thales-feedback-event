...
const Header: React.FC = () => {
  // Logo Thales officiel en Base64
  const fullLogo = "data:image/png;base64,iVBORw0KGgoAAA... (tronqué pour la lisibilité, identique au précédent)";
  // Utilisation simplifiée sans animations complexes pour garantir la visibilité immédiate
  return (
    <div className="text-center mb-10 w-full">
      ...
      <p className="text-blue-100 max-w-2xl mx-auto leading-relaxed text-lg font-medium opacity-95">
